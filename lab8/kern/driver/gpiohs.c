...
void gpiohs_set_drive_mode(uint8_t gpiohs_pin, gpio_drive_mode_t mode)
{
    ...
    set_bit_p(gpiohs_dir ? gpiohs->output_en.u32 : gpiohs->input_en.u32, bound_pin);
    clear_bit_p((!gpiohs_dir) ? gpiohs->output_en.u32 : gpiohs->input_en.u32, bound_pin);
}
...
void gpiohs_set_pin_output_value(uint8_t gpiohs_pin, gpio_pin_value_t value)
{
    ...
    {
    case GPIO_PV_LOW:
        clear_bit_p(gpiohs->output_val.u32, gpiohs_pin);
        break;
    case GPIO_PV_HIGH:
        set_bit_p(gpiohs->output_val.u32, gpiohs_pin);
        break;
    default:
        break;
    }

...
#ifndef LAB8_SYSCTL_H
#define LAB8_SYSCTL_H
...
typedef enum _sysctl_clock_source_t
{
    ...
    SYSCTL_CLOCK_SOURCE_PLL0,
    SYSCTL_CLOCK_SOURCE_PLL1,
    SYSCTL_CLOCK_SOURCE_PLL2,
    SYSCTL_CLOCK_SOURCE_ACLK,
    SYSCTL_CLOCK_SOURCE_MAX
